...
.method public static parse(Lcom/google/android/exoplayer2/util/ParsableByteArray;)Lcom/google/android/exoplayer2/video/AvcConfig;
    ...
    const-string v12, "Error parsing AVC config"

    invoke-direct {v0, v12, v6}, Lcom/google/android/exoplayer2/ParserException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, v2, v12}, Lcom/google/android/exoplayer2/util/NalUnitUtil;->parseSpsNalUnit([BII)Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;

    move-result-object v11

    .line 70
    .local v11, "spsData":Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;
    iget v3, v11, Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;->width:I

    .line 71
    iget v4, v11, Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;->height:I

    .line 72
    iget v5, v11, Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;->pixelWidthAspectRatio:F

    .line 74
    .end local v10    # "sps":[B
    .end local v11    # "spsData":Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;
    :cond_66
    ...
    :try_end_6b
    .catch Ljava/lang/ArrayIndexOutOfBoundsException; {:try_start_1e .. :try_end_6b} :catch_15
