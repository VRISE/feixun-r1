...
.method public constructor <init>(I[BJJ)V
    ...
    iput-object v4, p0, Lcom/google/android/exoplayer2/upstream/crypto/AesFlushingCipher;->cipher:Ljavax/crypto/Cipher;

    .line 47
    iget-object v4, p0, Lcom/google/android/exoplayer2/upstream/crypto/AesFlushingCipher;->cipher:Ljavax/crypto/Cipher;

    invoke-virtual {v4}, Ljavax/crypto/Cipher;->getBlockSize()I

    move-result v4

    iput v4, p0, Lcom/google/android/exoplayer2/upstream/crypto/AesFlushingCipher;->blockSize:I
    ...
    iput-object v4, p0, Lcom/google/android/exoplayer2/upstream/crypto/AesFlushingCipher;->zerosBlock:[B
    ...
    iput-object v4, p0, Lcom/google/android/exoplayer2/upstream/crypto/AesFlushingCipher;->flushedBlock:[B
    ...
    iget-object v6, p0, Lcom/google/android/exoplayer2/upstream/crypto/AesFlushingCipher;->cipher:Ljavax/crypto/Cipher;
    ...
    invoke-virtual {p0, v4, v5, v3}, Lcom/google/android/exoplayer2/upstream/crypto/AesFlushingCipher;->updateInPlace([BII)V
    :try_end_54
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_3 .. :try_end_54} :catch_5c
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_3 .. :try_end_54} :catch_5e
    .catch Ljava/security/InvalidKeyException; {:try_start_3 .. :try_end_54} :catch_60
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_3 .. :try_end_54} :catch_55
...
.method private nonFlushingUpdate([BII[BI)I
    ...
    :try_end_a
    .catch Ljavax/crypto/ShortBufferException; {:try_start_0 .. :try_end_a} :catch_c
...
.method public update([BII[BI)V
    ...
    .line 84
    :cond_22
    invoke-direct/range {p0 .. p5}, Lcom/google/android/exoplayer2/upstream/crypto/AesFlushingCipher;->nonFlushingUpdate([BII[BI)I
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/crypto/AesFlushingCipher;->flushedBlock:[B
