...
.method private handleC1Command(I)V
    ...
    const-string v5, "Invalid C1 command: "
...
.method private processCurrentPacket()V
    ...
    iget-object v6, p0, Lcom/google/android/exoplayer2/text/cea/Cea708Decoder;->currentDtvCcPacket:Lcom/google/android/exoplayer2/text/cea/Cea708Decoder$DtvCcPacket;

    iget v6, v6, Lcom/google/android/exoplayer2/text/cea/Cea708Decoder$DtvCcPacket;->packetSize:I
    ...
    iget v6, v6, Lcom/google/android/exoplayer2/text/cea/Cea708Decoder$DtvCcPacket;->currentIndex:I
    ...
    iget v6, v6, Lcom/google/android/exoplayer2/text/cea/Cea708Decoder$DtvCcPacket;->sequenceNumber:I

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v6, "); ignoring packet"
    ...
    invoke-virtual {v4, v5, v6}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->reset([BI)V
    ...
    const-string v6, "serviceNumber is non-zero ("
    ...
    const-string v6, ") when blockSize is 0"
    ...
    .line 284
    :cond_aa
    iget v4, p0, Lcom/google/android/exoplayer2/text/cea/Cea708Decoder;->selectedServiceNumber:I
    ...
    iput-object v4, p0, Lcom/google/android/exoplayer2/text/cea/Cea708Decoder;->cues:Ljava/util/List;
...
.method protected decode(Lcom/google/android/exoplayer2/text/SubtitleInputBuffer;)V
    ...
    const-string v8, "Encountered DTVCC_PACKET_DATA before DTVCC_PACKET_START"
