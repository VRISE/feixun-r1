...
.method static synthetic access$100(Lrx/observables/AsyncOnSubscribe$AsyncOuterManager;)Lrx/subscriptions/CompositeSubscription;
    .registers 2
    .param p0, "x0"    # Lrx/observables/AsyncOnSubscribe$AsyncOuterManager;
...
.method private subscribeBufferToObservable(Lrx/Observable;)V
    ...
    iget-object v4, p0, Lrx/observables/AsyncOnSubscribe$AsyncOuterManager;->subscriptions:Lrx/subscriptions/CompositeSubscription;

    invoke-virtual {v4, v1}, Lrx/subscriptions/CompositeSubscription;->add(Lrx/Subscription;)V

    .line 611
    new-instance v4, Lrx/observables/AsyncOnSubscribe$AsyncOuterManager$2;

    invoke-direct {v4, p0, v1}, Lrx/observables/AsyncOnSubscribe$AsyncOuterManager$2;-><init>(Lrx/observables/AsyncOnSubscribe$AsyncOuterManager;Lrx/Subscriber;)V

    invoke-virtual {p1, v4}, Lrx/Observable;->doOnTerminate(Lrx/functions/Action0;)Lrx/Observable;

    move-result-object v4

    invoke-virtual {v4, v1}, Lrx/Observable;->subscribe(Lrx/Subscriber;)Lrx/Subscription;

    .line 618
    iget-object v4, p0, Lrx/observables/AsyncOnSubscribe$AsyncOuterManager;->merger:Lrx/observables/AsyncOnSubscribe$UnicastSubject;

    invoke-virtual {v4, v0}, Lrx/observables/AsyncOnSubscribe$UnicastSubject;->onNext(Ljava/lang/Object;)V
