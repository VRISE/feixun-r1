...
.method protected buildAudioRenderers(Landroid/content/Context;Lcom/google/android/exoplayer2/drm/DrmSessionManager;[Lcom/google/android/exoplayer2/audio/AudioProcessor;Landroid/os/Handler;Lcom/google/android/exoplayer2/audio/AudioRendererEventListener;ILjava/util/ArrayList;)V
    ...
    :try_end_56
    .catch Ljava/lang/ClassNotFoundException; {:try_start_28 .. :try_end_56} :catch_e3
    .catch Ljava/lang/Exception; {:try_start_28 .. :try_end_56} :catch_e8
    ...
    :try_end_64
    .catch Ljava/lang/ClassNotFoundException; {:try_start_58 .. :try_end_64} :catch_110
    .catch Ljava/lang/Exception; {:try_start_58 .. :try_end_64} :catch_10e
    ...
    check-cast v14, Lcom/google/android/exoplayer2/Renderer;
    :try_end_93
    .catch Ljava/lang/ClassNotFoundException; {:try_start_65 .. :try_end_93} :catch_f0
    .catch Ljava/lang/Exception; {:try_start_65 .. :try_end_93} :catch_f4
    ...
    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_a1
    .catch Ljava/lang/ClassNotFoundException; {:try_start_95 .. :try_end_a1} :catch_10c
    .catch Ljava/lang/Exception; {:try_start_95 .. :try_end_a1} :catch_10a
    ...
    check-cast v14, Lcom/google/android/exoplayer2/Renderer;
    :try_end_d0
    .catch Ljava/lang/ClassNotFoundException; {:try_start_a2 .. :try_end_d0} :catch_106
    .catch Ljava/lang/Exception; {:try_start_a2 .. :try_end_d0} :catch_fc
    ...
    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_de
    .catch Ljava/lang/ClassNotFoundException; {:try_start_d2 .. :try_end_de} :catch_e0
    .catch Ljava/lang/Exception; {:try_start_d2 .. :try_end_de} :catch_104
...
.method protected buildMetadataRenderers(Landroid/content/Context;Lcom/google/android/exoplayer2/metadata/MetadataRenderer$Output;Landroid/os/Looper;ILjava/util/ArrayList;)V
    .registers 7
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "output"    # Lcom/google/android/exoplayer2/metadata/MetadataRenderer$Output;
...
.method protected buildTextRenderers(Landroid/content/Context;Lcom/google/android/exoplayer2/text/TextRenderer$Output;Landroid/os/Looper;ILjava/util/ArrayList;)V
    .registers 7
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "output"    # Lcom/google/android/exoplayer2/text/TextRenderer$Output;
    .param p3, "outputLooper"    # Landroid/os/Looper;
    .param p4, "extensionRendererMode"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method protected buildVideoRenderers(Landroid/content/Context;Lcom/google/android/exoplayer2/drm/DrmSessionManager;JLandroid/os/Handler;Lcom/google/android/exoplayer2/video/VideoRendererEventListener;ILjava/util/ArrayList;)V
    ...
    :try_end_76
    .catch Ljava/lang/ClassNotFoundException; {:try_start_29 .. :try_end_76} :catch_98
    .catch Ljava/lang/Exception; {:try_start_29 .. :try_end_76} :catch_8b
    ...
    :try_end_88
    .catch Ljava/lang/ClassNotFoundException; {:try_start_78 .. :try_end_88} :catch_89
    .catch Ljava/lang/Exception; {:try_start_78 .. :try_end_88} :catch_96
...
.method public createRenderers(Landroid/os/Handler;Lcom/google/android/exoplayer2/video/VideoRendererEventListener;Lcom/google/android/exoplayer2/audio/AudioRendererEventListener;Lcom/google/android/exoplayer2/text/TextRenderer$Output;Lcom/google/android/exoplayer2/metadata/MetadataRenderer$Output;)[Lcom/google/android/exoplayer2/Renderer;
    ...
    .param p4, "textRendererOutput"    # Lcom/google/android/exoplayer2/text/TextRenderer$Output;
    .param p5, "metadataRendererOutput"    # Lcom/google/android/exoplayer2/metadata/MetadataRenderer$Output;
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/google/android/exoplayer2/DefaultRenderersFactory;->buildTextRenderers(Landroid/content/Context;Lcom/google/android/exoplayer2/text/TextRenderer$Output;Landroid/os/Looper;ILjava/util/ArrayList;)V
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/google/android/exoplayer2/DefaultRenderersFactory;->buildMetadataRenderers(Landroid/content/Context;Lcom/google/android/exoplayer2/metadata/MetadataRenderer$Output;Landroid/os/Looper;ILjava/util/ArrayList;)V
