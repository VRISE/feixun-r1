...
.method public constructor <init>(JJJZJJJLcom/google/android/exoplayer2/source/dash/manifest/UtcTimingElement;Landroid/net/Uri;Ljava/util/List;)V
    ...
    .end local p16    # "periods":Ljava/util/List;, "Ljava/util/List<Lcom/google/android/exoplayer2/source/dash/manifest/Period;>;"
    :cond_1d
...
.method private static copyAdaptationSets(Ljava/util/List;Ljava/util/LinkedList;)Ljava/util/ArrayList;
    ...
    check-cast v4, Lcom/google/android/exoplayer2/source/dash/manifest/RepresentationKey;

    .line 122
    .local v4, "key":Lcom/google/android/exoplayer2/source/dash/manifest/RepresentationKey;
    iget v5, v4, Lcom/google/android/exoplayer2/source/dash/manifest/RepresentationKey;->periodIndex:I
    ...
    :cond_d
    iget v1, v4, Lcom/google/android/exoplayer2/source/dash/manifest/RepresentationKey;->adaptationSetIndex:I
    ...
    .line 129
    .local v7, "representations":Ljava/util/List;, "Ljava/util/List<Lcom/google/android/exoplayer2/source/dash/manifest/Representation;>;"
    ...
    :cond_1c
    iget v8, v4, Lcom/google/android/exoplayer2/source/dash/manifest/RepresentationKey;->representationIndex:I
    ...
    .end local v4    # "key":Lcom/google/android/exoplayer2/source/dash/manifest/RepresentationKey;
    check-cast v4, Lcom/google/android/exoplayer2/source/dash/manifest/RepresentationKey;

    .line 134
    .restart local v4    # "key":Lcom/google/android/exoplayer2/source/dash/manifest/RepresentationKey;
    iget v8, v4, Lcom/google/android/exoplayer2/source/dash/manifest/RepresentationKey;->periodIndex:I

    if-ne v8, v5, :cond_35

    iget v8, v4, Lcom/google/android/exoplayer2/source/dash/manifest/RepresentationKey;->adaptationSetIndex:I
    ...
    iget v9, v0, Lcom/google/android/exoplayer2/source/dash/manifest/AdaptationSet;->id:I

    iget v10, v0, Lcom/google/android/exoplayer2/source/dash/manifest/AdaptationSet;->type:I

    iget-object v11, v0, Lcom/google/android/exoplayer2/source/dash/manifest/AdaptationSet;->accessibilityDescriptors:Ljava/util/List;

    invoke-direct {v8, v9, v10, v3, v11}, Lcom/google/android/exoplayer2/source/dash/manifest/AdaptationSet;-><init>(IILjava/util/List;Ljava/util/List;)V
...
.method public final copy(Ljava/util/List;)Lcom/google/android/exoplayer2/source/dash/manifest/DashManifest;
    ...
    .line 94
    .local v20, "keys":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Lcom/google/android/exoplayer2/source/dash/manifest/RepresentationKey;>;"
    ...
    .line 98
    .local v18, "copyPeriods":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/google/android/exoplayer2/source/dash/manifest/Period;>;"
    ...
    .line 108
    .local v21, "period":Lcom/google/android/exoplayer2/source/dash/manifest/Period;
    ...
    .line 110
    .local v19, "copyAdaptationSets":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/google/android/exoplayer2/source/dash/manifest/AdaptationSet;>;"
    ...
    .line 113
    .end local v19    # "copyAdaptationSets":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/google/android/exoplayer2/source/dash/manifest/AdaptationSet;>;"
    .end local v21    # "period":Lcom/google/android/exoplayer2/source/dash/manifest/Period;
    :cond_75
    move-object/from16 v0, p0

    iget-wide v2, v0, Lcom/google/android/exoplayer2/source/dash/manifest/DashManifest;->duration:J
    ...
    iget-wide v3, v0, Lcom/google/android/exoplayer2/source/dash/manifest/DashManifest;->availabilityStartTime:J

    move-object/from16 v0, p0

    iget-wide v7, v0, Lcom/google/android/exoplayer2/source/dash/manifest/DashManifest;->minBufferTime:J
    ...
    iget-wide v10, v0, Lcom/google/android/exoplayer2/source/dash/manifest/DashManifest;->minUpdatePeriod:J

    move-object/from16 v0, p0

    iget-wide v12, v0, Lcom/google/android/exoplayer2/source/dash/manifest/DashManifest;->timeShiftBufferDepth:J

    move-object/from16 v0, p0

    iget-wide v14, v0, Lcom/google/android/exoplayer2/source/dash/manifest/DashManifest;->suggestedPresentationDelay:J
    ...
    invoke-direct/range {v2 .. v18}, Lcom/google/android/exoplayer2/source/dash/manifest/DashManifest;-><init>(JJJZJJJLcom/google/android/exoplayer2/source/dash/manifest/UtcTimingElement;Landroid/net/Uri;Ljava/util/List;)V
...
.method public final getPeriodDurationMs(I)J
    ...
    iget-wide v2, p0, Lcom/google/android/exoplayer2/source/dash/manifest/DashManifest;->duration:J
