...
.method public addSample(IF)V
    ...
    iput v4, p0, Lcom/google/android/exoplayer2/util/SlidingPercentile;->recycledSampleCount:I

    aget-object v1, v3, v4

    .line 89
    .local v1, "newSample":Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;
    :goto_12
    iget v3, p0, Lcom/google/android/exoplayer2/util/SlidingPercentile;->nextSampleIndex:I

    add-int/lit8 v4, v3, 0x1

    iput v4, p0, Lcom/google/android/exoplayer2/util/SlidingPercentile;->nextSampleIndex:I

    iput v3, v1, Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;->index:I

    .line 90
    iput p1, v1, Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;->weight:I

    .line 91
    iput p2, v1, Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;->value:F
    ...
    iget v4, p0, Lcom/google/android/exoplayer2/util/SlidingPercentile;->maxWeight:I
    ...
    .end local v1    # "newSample":Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;
    .end local v2    # "oldestSample":Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;
    :cond_5c
    new-instance v1, Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;

    const/4 v3, 0x0

    invoke-direct {v1, v3}, Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;-><init>(Lcom/google/android/exoplayer2/util/SlidingPercentile$1;)V

    goto :goto_12

    .line 105
    .restart local v0    # "excessWeight":I
    .restart local v1    # "newSample":Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;
    .restart local v2    # "oldestSample":Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;
    :cond_63
    iget v3, v2, Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;->weight:I
...
.method public getPercentile(F)F
    ...
    check-cast v1, Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;

    .line 123
    .local v1, "currentSample":Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;
    iget v4, v1, Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;->weight:I
    ...
    .line 125
    iget v4, v1, Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;->value:F

    .line 129
    .end local v1    # "currentSample":Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;
    :goto_24
    return v4

    .line 121
    .restart local v1    # "currentSample":Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;
    :cond_25
    ...
    iget-object v5, p0, Lcom/google/android/exoplayer2/util/SlidingPercentile;->samples:Ljava/util/ArrayList;
    ...
    check-cast v4, Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;

    iget v4, v4, Lcom/google/android/exoplayer2/util/SlidingPercentile$Sample;->value:F
