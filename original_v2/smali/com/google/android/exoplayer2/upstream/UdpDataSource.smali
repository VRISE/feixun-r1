...
.method public constructor <init>(Lcom/google/android/exoplayer2/upstream/TransferListener;)V
    ...
    .prologue
    .line 72
    .local p1, "listener":Lcom/google/android/exoplayer2/upstream/TransferListener;, "Lcom/google/android/exoplayer2/upstream/TransferListener<-Lcom/google/android/exoplayer2/upstream/UdpDataSource;>;"
    const/16 v0, 0x7d0
...
.method public close()V
    ...
    :try_end_f
    .catch Ljava/io/IOException; {:try_start_8 .. :try_end_f} :catch_32
...
.method public open(Lcom/google/android/exoplayer2/upstream/DataSpec;)J
    ...
    iput-object v3, p0, Lcom/google/android/exoplayer2/upstream/UdpDataSource;->uri:Landroid/net/Uri;

    .line 100
    iget-object v3, p0, Lcom/google/android/exoplayer2/upstream/UdpDataSource;->uri:Landroid/net/Uri;
    ...
    iput-object v3, p0, Lcom/google/android/exoplayer2/upstream/UdpDataSource;->address:Ljava/net/InetAddress;
    ...
    iput-object v3, p0, Lcom/google/android/exoplayer2/upstream/UdpDataSource;->socketAddress:Ljava/net/InetSocketAddress;
    ...
    iget-object v4, p0, Lcom/google/android/exoplayer2/upstream/UdpDataSource;->socketAddress:Ljava/net/InetSocketAddress;
    ...
    :try_end_3b
    .catch Ljava/io/IOException; {:try_start_10 .. :try_end_3b} :catch_5b
    ...
    :try_end_42
    .catch Ljava/net/SocketException; {:try_start_3b .. :try_end_42} :catch_62
    ...
    .line 124
    iget-object v3, p0, Lcom/google/android/exoplayer2/upstream/UdpDataSource;->listener:Lcom/google/android/exoplayer2/upstream/TransferListener;
    ...
    invoke-interface {v3, p0, p1}, Lcom/google/android/exoplayer2/upstream/TransferListener;->onTransferStart(Ljava/lang/Object;Lcom/google/android/exoplayer2/upstream/DataSpec;)V
    ...
    invoke-direct {v3, v0}, Lcom/google/android/exoplayer2/upstream/UdpDataSource$UdpDataSourceException;-><init>(Ljava/io/IOException;)V
...
.method public read([BII)I
    ...
    .line 136
    :cond_4
    iget v3, p0, Lcom/google/android/exoplayer2/upstream/UdpDataSource;->packetRemaining:I
    ...
    iget-object v4, p0, Lcom/google/android/exoplayer2/upstream/UdpDataSource;->packet:Ljava/net/DatagramPacket;

    invoke-virtual {v3, v4}, Ljava/net/DatagramSocket;->receive(Ljava/net/DatagramPacket;)V
    :try_end_f
    .catch Ljava/io/IOException; {:try_start_8 .. :try_end_f} :catch_3d

    .line 143
    iget-object v3, p0, Lcom/google/android/exoplayer2/upstream/UdpDataSource;->packet:Ljava/net/DatagramPacket;
    ...
    iget v4, p0, Lcom/google/android/exoplayer2/upstream/UdpDataSource;->packetRemaining:I

    invoke-interface {v3, p0, v4}, Lcom/google/android/exoplayer2/upstream/TransferListener;->onBytesTransferred(Ljava/lang/Object;I)V
    ...
    iget-object v3, p0, Lcom/google/android/exoplayer2/upstream/UdpDataSource;->packetBuffer:[B
    ...
    invoke-direct {v3, v1}, Lcom/google/android/exoplayer2/upstream/UdpDataSource$UdpDataSourceException;-><init>(Ljava/io/IOException;)V
