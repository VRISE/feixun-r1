...
.method public getCachedBytes(JJ)J
    ...
    .line 130
    .local v5, "span":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    invoke-virtual {v5}, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->isHoleSpan()Z
    ...
    .line 132
    invoke-virtual {v5}, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->isOpenEnded()Z
    ...
    iget-wide v8, v5, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->position:J

    iget-wide v10, v5, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->length:J
    ...
    .line 137
    iget-object v8, p0, Lcom/google/android/exoplayer2/upstream/cache/CachedContent;->cachedSpans:Ljava/util/TreeSet;
    ...
    check-cast v4, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;

    .line 138
    .local v4, "next":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    iget-wide v10, v4, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->position:J
    ...
    .line 151
    .end local v4    # "next":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    :cond_49
    :goto_49
    sub-long v8, v2, p1
    ...
    .line 144
    .restart local v4    # "next":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    :cond_52
    iget-wide v10, v4, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->position:J

    iget-wide v12, v4, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->length:J
...
.method public getSpan(J)Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    ...
    invoke-static {v3, p1, p2}, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->createLookup(Ljava/lang/String;J)Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;

    move-result-object v2

    .line 110
    .local v2, "lookupSpan":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    ...
    .line 116
    .end local v1    # "floorSpan":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    :goto_19
    return-object v1

    .line 114
    .restart local v1    # "floorSpan":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    :cond_1a
    iget-object v3, p0, Lcom/google/android/exoplayer2/upstream/cache/CachedContent;->cachedSpans:Ljava/util/TreeSet;
    ...
    .line 115
    .local v0, "ceilSpan":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    if-nez v0, :cond_2c
...
.method public headerHashCode()I
    ...
    iget-wide v2, p0, Lcom/google/android/exoplayer2/upstream/cache/CachedContent;->length:J

    iget-wide v4, p0, Lcom/google/android/exoplayer2/upstream/cache/CachedContent;->length:J
...
.method public touch(Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;)Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    ...
    .line 166
    iget v1, p0, Lcom/google/android/exoplayer2/upstream/cache/CachedContent;->id:I

    invoke-virtual {p1, v1}, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->copyWithUpdatedLastAccessTime(I)Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
