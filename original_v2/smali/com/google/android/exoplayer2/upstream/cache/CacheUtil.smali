...
.method public static getCached(Lcom/google/android/exoplayer2/upstream/DataSpec;Lcom/google/android/exoplayer2/upstream/cache/Cache;Lcom/google/android/exoplayer2/upstream/cache/CacheUtil$CachingCounters;)Lcom/google/android/exoplayer2/upstream/cache/CacheUtil$CachingCounters;
    ...
    .catch Ljava/lang/InterruptedException; {:try_start_7 .. :try_end_a} :catch_13
...
.method private static internalCache(Lcom/google/android/exoplayer2/upstream/DataSpec;Lcom/google/android/exoplayer2/upstream/cache/Cache;Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;[BLcom/google/android/exoplayer2/util/PriorityTaskManager;ILcom/google/android/exoplayer2/upstream/cache/CacheUtil$CachingCounters;)Lcom/google/android/exoplayer2/upstream/cache/CacheUtil$CachingCounters;
    ...
    iget-wide v12, v0, Lcom/google/android/exoplayer2/upstream/cache/CacheUtil$CachingCounters;->alreadyCachedBytes:J

    add-long v12, v12, v18

    move-object/from16 v0, p6

    iput-wide v12, v0, Lcom/google/android/exoplayer2/upstream/cache/CacheUtil$CachingCounters;->alreadyCachedBytes:J
    ...
    iput-wide v12, v0, Lcom/google/android/exoplayer2/upstream/cache/CacheUtil$CachingCounters;->downloadedBytes:J
    ...
    iget-object v11, v0, Lcom/google/android/exoplayer2/upstream/DataSpec;->uri:Landroid/net/Uri;
    ...
    .line 157
    .local v10, "subDataSpec":Lcom/google/android/exoplayer2/upstream/DataSpec;
    ...
    invoke-static {v10, v0, v1, v2, v3}, Lcom/google/android/exoplayer2/upstream/cache/CacheUtil;->readAndDiscard(Lcom/google/android/exoplayer2/upstream/DataSpec;Lcom/google/android/exoplayer2/upstream/DataSource;[BLcom/google/android/exoplayer2/util/PriorityTaskManager;I)J
    ...
    iget-wide v12, v0, Lcom/google/android/exoplayer2/upstream/cache/CacheUtil$CachingCounters;->downloadedBytes:J
    ...
    .line 176
    .end local v10    # "subDataSpec":Lcom/google/android/exoplayer2/upstream/DataSpec;
    .end local v18    # "blockLength":J
...
.method private static readAndDiscard(Lcom/google/android/exoplayer2/upstream/DataSpec;Lcom/google/android/exoplayer2/upstream/DataSource;[BLcom/google/android/exoplayer2/util/PriorityTaskManager;I)J
    ...
    .param p2, "buffer"    # [B
    .param p3, "priorityTaskManager"    # Lcom/google/android/exoplayer2/util/PriorityTaskManager;
    .param p4, "priority"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    throw v1
    :try_end_16
    .catch Lcom/google/android/exoplayer2/util/PriorityTaskManager$PriorityTooLowException; {:try_start_5 .. :try_end_16} :catch_16
    ...
    invoke-interface {p1, p2, v1, v4}, Lcom/google/android/exoplayer2/upstream/DataSource;->read([BII)I
    :try_end_20
    .catch Lcom/google/android/exoplayer2/util/PriorityTaskManager$PriorityTooLowException; {:try_start_1c .. :try_end_20} :catch_16
...
.method public static remove(Lcom/google/android/exoplayer2/upstream/cache/Cache;Ljava/lang/String;)V
    ...
    :try_end_1a
    .catch Lcom/google/android/exoplayer2/upstream/cache/Cache$CacheException; {:try_start_17 .. :try_end_1a} :catch_1b
