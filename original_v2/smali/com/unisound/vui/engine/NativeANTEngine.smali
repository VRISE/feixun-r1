...
.method public static writeVoiceLog(Ljava/lang/String;Ljava/lang/String;)V
    .registers 7
    .param p0, "tag"
    .param p1, "content"
    ...
    const-string v1, "/sdcard/voice_log.txt"
    ...
    :try_end_5e
    .catch Ljava/lang/Exception; {:try_start_8 .. :try_end_5e} :catch_5e
...
.method public static interceptTTS(Ljava/lang/String;)Ljava/lang/String;
    .registers 10
    .param p0, "original"

    :try_start_0
    # v29: interceptTTS 已废弃 - 不再做任何 HTTP 调用
    # 天气和音乐功能已迁移到 Pipeline Handler（不会卡死）
    # 直接返回原始 TTS 文本
    const-string v0, "V30_DEBUG"
    const-string v1, "interceptTTS bypassed (v30)"
    invoke-static {v0, v1}, Lcom/unisound/vui/engine/NativeANTEngine;->writeVoiceLog(Ljava/lang/String;Ljava/lang/String;)V
    return-object p0

    # 以下代码已被禁用，因为 interceptTTS 中的 HTTP 调用会导致卡死
    # 天气: PhicommWeatherHandler (优先级 310)
    # 音乐: PhicommMusicSearchHandler (优先级 310)
    # 这些 Handler 在 ANT 工作线程中运行，可以安全发 HTTP
    if-nez p0, :cond_v16_start

    :cond_check_music_v17
    :cond_is_music_v17
    :cond_v16_start
    # v16原有代码
    new-instance v0, Ljava/io/File;
    const-string v1, "/sdcard/tts_replace.txt"
    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V
    invoke-virtual {v0}, Ljava/io/File;->exists()Z
    move-result v1
    if-nez v1, :cond_10
...
.method protected declared-synchronized doEnterWakeup(Z)V
    ...
    :try_end_e
    .catchall {:try_start_1 .. :try_end_e} :catchall_b4
    ...
    invoke-virtual {v0, v1}, Lcom/unisound/vui/a;->b(Ljava/lang/String;)V
    :try_end_108
    .catchall {:try_start_b7 .. :try_end_108} :catchall_b4
...
.method protected doPlayTTS(Ljava/lang/String;)V
    ...
    invoke-static {v0, p1}, Lcom/unisound/vui/engine/NativeANTEngine;->writeVoiceLog(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p1}, Lcom/unisound/vui/engine/NativeANTEngine;->interceptTTS(Ljava/lang/String;)Ljava/lang/String;
...
.method protected setWakeupWord0(Ljava/util/List;Z)V
    ...
    invoke-virtual {p0}, Lcom/unisound/vui/engine/NativeANTEngine;->doCancelEngine()V
    :try_end_36
    .catch Ljava/lang/Exception; {:try_start_33 .. :try_end_36} :catch_4e
    ...
    invoke-virtual {p0}, Lcom/unisound/vui/engine/NativeANTEngine;->doCancelEngine()V
    :try_end_56
    .catch Ljava/lang/Exception; {:try_start_53 .. :try_end_56} :catch_bd
