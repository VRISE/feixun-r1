...
.method public static findAllTableNames(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;
    ...
    :try_end_30
    .catch Ljava/lang/Exception; {:try_start_6 .. :try_end_30} :catch_39
    ...
    throw v4
    :try_end_47
    .catchall {:try_start_3a .. :try_end_47} :catchall_47
...
.method public static findPragmaTableInfo(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Lorg/litepal/tablemanager/model/TableModel;
    ...
    :try_end_87
    .catch Ljava/lang/Exception; {:try_start_2a .. :try_end_87} :catch_95
    .catchall {:try_start_2a .. :try_end_87} :catchall_a3
    ...
    const-string v3, ""
    :try_end_94
    .catch Ljava/lang/Exception; {:try_start_92 .. :try_end_94} :catch_95
    .catchall {:try_start_92 .. :try_end_94} :catchall_a3
...
.method public static findUniqueColumns(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;
    ...
    invoke-interface {v2}, Landroid/database/Cursor;->moveToNext()Z
    :try_end_6e
    .catch Ljava/lang/Exception; {:try_start_7 .. :try_end_6e} :catch_7c
    .catchall {:try_start_7 .. :try_end_6e} :catchall_8a
...
.method public static isColumnExists(Ljava/lang/String;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Z
    ...
    :try_end_3d
    .catch Ljava/lang/Exception; {:try_start_10 .. :try_end_3d} :catch_4e
    .catchall {:try_start_10 .. :try_end_3d} :catchall_59
...
.method public static isIntermediateTable(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Z
    ...
    :try_end_3c
    .catch Ljava/lang/Exception; {:try_start_10 .. :try_end_3c} :catch_53
    .catchall {:try_start_10 .. :try_end_3c} :catchall_5d
    ...
    :try_end_49
    .catch Ljava/lang/Exception; {:try_start_46 .. :try_end_49} :catch_53
